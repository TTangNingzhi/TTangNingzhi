...
I'm a Ph.D. candidate in Computer Science at the University of Notre Dame, advised by [Prof. Toby Jia-Jun Li](https://toby.li/) in the SaNDwichLab 🥪. My research sits at the intersection of AI, Software Engineering, and HCI. Previously, I completed my undergraduate studies at SUSTech in Shenzhen.

- 🛠️ I'm a **agent builder** and **AI researcher**. I build interactive tools and conduct user studies to explore how developers work with coding agents.
- 💼 This summer, I'm interning at **Google** as a UXE intern, working on self-improving coding agents.
- 🤖 I'm actively building my technical foundation in **LLMs** and **AI coding agents** from scratch — always excited to discuss what's happening on the frontier.
